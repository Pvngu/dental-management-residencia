...
class CreateCompaniesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('companies', function (Blueprint $table) {
            ...
            $table->bigInteger('lang_id')->unsigned()->nullable()->default(1);
            ...
            $table->integer('max_clinic_locations')->default(1);
            $table->string('email_verification_code')->nullable()->default(null);
            $table->boolean('verified')->default(false);
            $table->integer('grace_period')->default(0);

            $table->boolean('enable_landing_page')->default(0);
            $table->string('company_slug')->nullable()->default(value: null); // If true, company slug will be used for landing page URL
