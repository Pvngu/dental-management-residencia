...
ApiRoute::group(['namespace' => 'App\SuperAdmin\Http\Controllers\Api', 'prefix' => 'superadmin', 'middleware' => ['api.superadmin.check']], function () {
    ...
    // Questionnaire Templates - specific routes must come before resource
    ...
    // Questionnaire Sections - specific routes must come before resource  
    ...
    // Questionnaire Instances - specific routes must come before resource
    ...
    // Questions - specific routes must come before resource
    ...
    ApiRoute::patch('questions/{questionXid}/options/{optionXid}', ['as' => 'api.questions.update-option', 'uses' => 'QuestionController@updateOption']);
    ...
    // Question full all - post only
    ApiRoute::post('questionnaire-create', 'QuestionController@createFull', $options);

    // Question Options - resource only
