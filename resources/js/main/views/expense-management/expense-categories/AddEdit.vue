        ...
        <a-form layout="vertical">
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-form-item
                        :label="$t('expense_categories.name')"
                        name="name"
                    ...
                    >
                        <a-input
                            ...
                            :placeholder="$t('common.placeholder_default_text', [$t('expense_categories.name')])"
                        />
                    </a-form-item>
                </a-col>
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-form-item
                        :label="$t('expense_categories.is_active')"
                        name="is_active"
                    ...
                    >
                        <a-select
                            ...
                            :placeholder="$t('common.select_default_text', [$t('expense_categories.is_active')])"
                            style="width: 100%"
                        >
            ...
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                    <a-form-item
                        :label="$t('expense_categories.description')"
                        name="description"
                    ...
                    >
                        <a-textarea
                            ...
                            :placeholder="$t('common.placeholder_default_text', [$t('expense_categories.description')])"
