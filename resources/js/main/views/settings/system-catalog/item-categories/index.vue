<template>
    <div class="item-categories-container">
        <div class="mb-4 flex justify-end gap-2">
            <a-button
                v-if="
                    permsArray.includes('item_categories_create') ||
            ...
            <a-button
                v-if="
                    ...
                    (permsArray.includes('item_categories_delete') ||
                        permsArray.includes('admin'))
                "
                type="primary"
            ...
            >
                ...
                <template #bodyCell="{ column, record }">
                    ...
                    <template v-if="column.dataIndex === 'action'">
                        <a-button
                            v-if="
                                permsArray.includes('item_categories_edit') ||
                                permsArray.includes('admin')
                            "
                            type="primary"
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            crudVariables.langKey.value = "item_categories";
