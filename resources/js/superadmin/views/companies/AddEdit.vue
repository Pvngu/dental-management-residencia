            ...
            <a-tabs v-model:activeKey="activeTabKey">
                ...
                >
                    ...
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('company.grace_period')"
                                name="grace_period"
                                :help="
                                    rules.grace_period
                                        ? rules.grace_period.message
                                        : null
                                "
                                :validateStatus="
                                    rules.grace_period ? 'error' : null
                                "
                            >
                                <a-input-number
                                    v-model:value="formData.grace_period"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('company.grace_period'),
                                        ])
                                    "
                                    style="width: 100%"
                                />
                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('company.max_clinic_locations')"
                                name="max_clinic_locations"
                                :help="
                                    rules.max_clinic_locations
                                        ? rules.max_clinic_locations.message
                                        : null
                                "
                                :validateStatus="
                                    rules.max_clinic_locations ? 'error' : null
                                "
                                class="required"
                            >
                                <a-input-number
                                    v-model:value="formData.max_clinic_locations"
                                    :min="1"
                                    :placeholder="
                                        $t('common.placeholder_default_text', [
                                            $t('company.max_clinic_locations'),
                                        ])
                                    "
                                    style="width: 100%"
                                />
                    ...
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                :label="$t('company.enable_landing_page')"
                                name="enable_landing_page"
                                :help="
                                    rules.enable_landing_page
                                        ? rules.enable_landing_page.message
                                        : null
                                "
                                :validateStatus="
                                    rules.enable_landing_page ? 'error' : null
                                "
                            >
                                <a-switch
                                    v-model:checked="
                                        formData.enable_landing_page
                                    "
                                    :checkedValue="1"
                                    :unCheckedValue="0"
                                />
